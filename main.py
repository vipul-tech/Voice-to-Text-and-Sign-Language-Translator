...
'voice', 'wednesday', 'weight']
        ...
        with sr.Microphone() as source:                 # use the default microphone as the audio source
                ...
                r.adjust_for_ambient_noise(source,duration=2)      # listen for 5 second to calibrate the energy threshold for ambient noise levels
                i=0
                while True:
                        print('Say Something...')
                        ...
                        try:
                                a=r.recognize_google(audio)       # recognize speech using Google Speech Recognition
                                ...
                                if(a.lower()=='goodbye'):
                                    ...
                                    lbl = ImageLabel(root)
                                    lbl.pack()
                                    lbl.load(r'/home/vipul/Desktop/Voice_To_Text_Or_Sign_Language_Translator/ISL_Gifs/{0}.gif'.format(a.lower()))
                                    root.mainloop()
                                else:
                                    ...
                                    for i in range(len(a)):
                                                    ...
                                                    if(a[i] in arr):
                                                            ...
                                                            ImageAddress = '/home/vipul/Desktop/Voice_To_Text_Or_Sign_Language_Translator/letters/'+a[i]+'.jpg'
...
while 1:
  image="signlang.png"
  msg="AUDIO TO TEXT AND SIGN LANGUAGE TRANSLATOR"
  choices = ["Record","Exit!"]
